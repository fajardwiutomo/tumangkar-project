export default function DeleteItemModal({ isOpen, onClose, onDelete, itemName, loadingDelete, setLoadingDelete }: {
    isOpen: boolean;
    onClose: () => void;
    onDelete: () => void;
    itemName: string;
            ...
            <div className="bg-white rounded-lg p-6 w-96">
                ...
                <div className="flex justify-end">
                    ...
                    <button
                        ...
                        onClick={onDelete}
                        className="flex gap-2 items-center px-4 py-2 text-sm font-medium text-white bg-red-500 rounded-md hover:bg-red-600"
                    >
                        {
                            loadingDelete &&
                            <div role="status">
